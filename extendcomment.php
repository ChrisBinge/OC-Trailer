...
Version: 1.0
Plugin URI: http://bingetech.com
Description: Add rating and fields to product posts.
...
function modify_comment( $text ){
	...
	echo '<p id="star-contain">';
	$comrating = get_comment_meta( get_comment_ID(), 'rating', true );
				for ( $commentrating = 1; $commentrating <= 5; $commentrating++ ) {
					if ( $commentrating <= $comrating ) {
